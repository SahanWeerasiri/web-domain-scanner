...
#         # Handle config as either an EnumerationConfig object or a dictionary
#         if isinstance(config, dict):
#             # Create EnumerationConfig from dict
#             enum_config = EnumerationConfig()
#             # Apply dict values to the config object
#             for key, value in config.items():
#                 if hasattr(enum_config, key):
#                     setattr(enum_config, key, value)
