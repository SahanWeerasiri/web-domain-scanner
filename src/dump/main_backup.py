...
#     from ..modules.service_discovery.config import ServiceDiscoveryConfig
#     from ..modules.service_discovery.base import (
...
# try:
#     from common.network_utils import NetworkUtils as CommonNetworkUtils
#     from common.constants import COMMON_SERVICES
# except ImportError:
#     # Fallback when common modules not available
#     CommonNetworkUtils = NetworkUtils
#     COMMON_SERVICES = PortRange.COMMON_PORTS
...
#                         for note in security_notes[:2]:  # Show first 2 notes
#                             print(f"        • {note}")
...
#                 if ports:
#                     print(f"  {service_type}: {len(ports)} ports")
...
#                     print(f"    • Port {concern['port']} - {concern['risk_level']} risk")
